"""
Fixed admin route files with proper session validation
"""
...
@admin_audit_bp.route('/audit-log')
@validate_session
def audit_log():
    ...
    try:
        history = audit_db.get_history(days=30)
    except:
        history = []
    
    return render_template('admin/audit_log.html', history=history, user=session['user'])


# ============================================
# routes/admin/facilities.py
# ============================================
"""
